...
let filter = myNumbers.filter(myNumbers=>myNumbers.length>100);
// Code Here
...
let  total = myNumbers.reduce(accmulater,currentValue) => accmulater + currentValue;
